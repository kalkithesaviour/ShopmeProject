...
public class UserController {
	...
	public String listByPage(
		...
		Page<User> page = service.listByPage(pageNum, sortField, sortDirec);
		...
		String reverseSortDirec = sortDirec.equals("asc") ? "desc" : "asc";
		...
		model.addAttribute("reverseSortDirec", reverseSortDirec);
